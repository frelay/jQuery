...
$(function(){
   ...
   */
   ...
   // Проверка событий
   /*
   load - проверяет загрузились ли все файлы проекта
   resize - проверяет меняется ли размер окна браузера
   scroll - срабатывает при скролинге страницы
   */   

   // События eventObject

   $('.recive').click(function (e) {       
      alert('Координаты по Х = ' + e.screenX + ', Координаты по Y = ' + e.screenY); // Проводит какие то действия с событиями
   });
